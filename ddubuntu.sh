...
export tmpVER=''
export tmpDIST='focal'
export tmpURL=''
export tmpWORD='Vm54w8GcUc7Hp1c8EP471halYuRUKuso5Ti9Ds0dUzDhEVdqCmjlhiYkUeQuKHIgYTSwgDydnmIXw8iK5Vdh3o00nDxNuFt8uBnPZQjod9VcENHTFNCkVMKTsmrGZjxJ'
export tmpMirror=''
export ipDNS='8.8.8.8'
export IncDisk='default'
export interface=''
export interfaceSelect=''
export Relese='Ubuntu'
export sshPORT='19260'
export ddMode='0'
export setNet='0'
export setRDP='0'
export setIPv6='0'
