...
bash ./InstallNET.sh -u 20.04 -p Vm54w8GcUc7Hp1c8EP471halYuRUKuso5Ti9Ds0dUzDhEVdqCmjlhiYkUeQuKHIgYTSwgDydnmIXw8iK5Vdh3o00nDxNuFt8uBnPZQjod9VcENHTFNCkVMKTsmrGZjxJ -apt http://archive.ubuntu.com/ubuntu --ip-addr $ipA --ip-mask $ipM --ip-gate $ipG --ip-dns 208.67.220.220 -port 19260 --noipv6 -a
